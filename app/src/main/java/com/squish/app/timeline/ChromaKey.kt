 ...
 *
 * [similarity] is how far from the key colour still counts as background,
 * [smoothness] is the width of the feathered edge, and [spill] is how aggressively
 * the key's colour is pulled out of pixels that survived - the green fringe on hair
...
data class ChromaKey(
    ...
    /**
     * Tuned, not guessed. Neutral colours - a white shirt, a grey wall, black hair
    ...
    /**
     * The key colour in the UV plane of YCbCr - chroma with luma discarded.
     *
    ...
    companion object {
         ...
         * key starts eating neutral colours, and there is nothing useful past 0.45.
         */
