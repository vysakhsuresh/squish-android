...
**Before a store release:** the OFL requires the full license text to travel with
...
normalized device coordinates to texture coordinates and does nothing else. The
